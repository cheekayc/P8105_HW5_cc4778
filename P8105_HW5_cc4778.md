...
```
    ...
    ##    <list>        <dbl>   <dbl>
    ##  1 <dbl [30]>   0.770    0.272
    ##  2 <dbl [30]>   0.802    0.374
    ##  3 <dbl [30]>   0.234    0.811
    ##  4 <dbl [30]>  -0.611    0.535
    ##  5 <dbl [30]>   0.512    0.530
    ##  6 <dbl [30]>   0.178    0.802
    ##  7 <dbl [30]>   0.143    0.882
    ##  8 <dbl [30]>   0.940    0.301
    ##  9 <dbl [30]>   0.0500   0.965
    ## 10 <dbl [30]>   1.54     0.115
...
```
    ...
    ##  1 <dbl [30]>          30       5         0    0.274   0.765
    ##  2 <dbl [30]>          30       5         0    0.142   0.852
    ##  3 <dbl [30]>          30       5         0    0.287   0.804
    ##  4 <dbl [30]>          30       5         0    1.42    0.101
    ##  5 <dbl [30]>          30       5         0    0.264   0.744
    ##  6 <dbl [30]>          30       5         0   -0.667   0.492
    ##  7 <dbl [30]>          30       5         0    0.446   0.600
    ##  8 <dbl [30]>          30       5         0   -0.457   0.555
    ##  9 <dbl [30]>          30       5         0    0.949   0.388
    ## 10 <dbl [30]>          30       5         0    0.304   0.754
...
(`$H_0: μ = 0$`), we can see that average sample mean only closely
